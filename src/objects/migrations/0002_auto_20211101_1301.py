...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='light',
            name='second_image',
            field=models.FileField(blank=True, help_text="Assurez vous que l'image n'est pas trop lourde.", null=True, upload_to=objects.models.logo_upload_to_2, verbose_name='photo n°2'),
        ),
        migrations.AddField(
            model_name='light',
            name='third_image',
            field=models.FileField(blank=True, help_text="Assurez vous que l'image n'est pas trop lourde.", null=True, upload_to=objects.models.logo_upload_to_3, verbose_name='photo n°3'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_image', models.FileField(blank=True, help_text="Assurez vous que l'image n'est pas trop lourde.", null=True, upload_to=objects.models.logo_upload_to_2, verbose_name='photo n°2')),
                ('third_image', models.FileField(blank=True, help_text="Assurez vous que l'image n'est pas trop lourde.", null=True, upload_to=objects.models.logo_upload_to_3, verbose_name='photo n°3')),
